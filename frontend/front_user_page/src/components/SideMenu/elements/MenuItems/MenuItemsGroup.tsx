...
const MenuItemsGroup = () =>{
    ...
    return(
        ...
        <MenuItems>
            <MenuItem hasSubMenu={false} icon={<FaArchway />} text="Main Page" onClick = {() => {navigate("/user/mainpage/dashboard")}} />
            ...
            {openIndex === 3 && (
                <SubMenuContainer>
                    ...
                    <MenuItem hasSubMenu={false}  text="My Desktops" onClick = {() => {navigate("/user/mainpage/mypage")}}/>
